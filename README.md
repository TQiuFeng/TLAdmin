...
- 后台布局：左侧菜单、顶部栏、面包屑、多标签页(刷新后恢复,可关闭其他/右侧/全部)、全屏、浅色/暗色/跟随系统主题、窄屏自动收起菜单、个人中心、退出登录。
...
顶栏右侧切换浅色 / 暗色 / 跟随系统，选择会记住；暗色下品牌绿单独调过，保证在深色卡片上看得清。

![暗色模式](docs/screenshots/dark-dashboard.png)
